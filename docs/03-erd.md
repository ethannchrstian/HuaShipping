...
erDiagram
    ...
    VOYAGE {
        ...
        bigint bunker_price_idr "V1.1, nullable"
...
Not shown: Django `User` (built-in, plus a `role` group: staff/viewer) and
audit history tables generated by django-simple-history on VOYAGE, PARCEL,
ACTIVITY, and master data.
